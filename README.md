...
Dr. Brooks Kim의 13개 인터랙티브 웹 애플리케이션 및 서비스 허브 포털입니다.
...
6. **[gitmark](https://drbrookskim.github.io/gitmark/)** (#08) — GitHub 기반 지능형 북마크 & 아카이브 피드 PWA
7. **[PITL](https://drbrookskim.github.io/pitl/)** (#07) — Starbucks Design System 기반 자율 제품 기획 워크스페이스
8. **[Signnith News Finder](https://drbrookskim.github.io/newsfinder/)** (#06) — On-Demand AI 실시간 금융/산업 뉴스 브리핑 검색 엔진
9. **[Dr. Brooks Thoughts](https://drbrookskim.github.io/thoughts/)** (#05) — 브런치 연동 지식 네트워크 그래프 & 생각 아카이브
10. **[EquiSense](https://drbrookskim.github.io/equisense/)** (#04) — 펀더멘털 · 해자 · 정성적 · 기술적 4단계 주식 심층 분석 플랫폼
11. **[SIGNNITH](https://drbrookskim.github.io/signnith/)** (#03) — 실시간 주식 시장 시그널 & 수급 인텔리전스 대시보드
12. **[오늘의 위스키](https://drbrookskim.github.io/todayswhisky/)** (#02) — MBTI & 바이오리듬 맞춤형 위스키 큐레이션 엔진
13. **[환율 NOW](https://drbrookskim.github.io/exchangenow/)** (#01) — 실시간 교차환율 계산기 및 통화 리포트 PWA
...
├── services.json     # 13개 서비스 런타임 데이터셋 (최신 역순)
