 ...
 * Ascending Chronological Order (#01 -> #12)
 */
...
(function () {
  ...
  const modalOrderBadge = document.getElementById('modalOrderBadge');
  ...
  const modalOrderVal = document.getElementById('modalOrderVal');
